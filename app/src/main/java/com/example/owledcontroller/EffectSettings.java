...
public class EffectSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra("selectedEffect")) {
            ...
            // Используйте selectedEffect в вашей активности
            ...
            startEffectButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    // Считайте значение SeekBar
                    int progress = seekBar.getProgress();

                    // Преобразуйте значение в диапазоне от 0 до 100 в значение от 0.0 до 1.0
                    float floatValue = progress / 100.0f;

                    // Создайте JSONObject для передачи данных в NetworkTask
                    ...
                    // Запустите NetworkTask с передачей jsonObject
